...
&emsp;&emsp;<font size=4>文章将在 **“[如何利用PaddleSeg做一个完整的项目(静态图)①](https://github.com/WhiteFireFox/paddleseg-tutorial/edit/main/pdseg/part1)”** 基础上，继续以一个例子为说明，来谈如何利用PaddleSeg完成一个项目。</font>
